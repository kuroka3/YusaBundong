...
public class GameManager : MonoBehaviour
{
    ...
    public static int DifficultyCode = 0;
    ...
    public static YusaBundongBeatmap[] Beatmaps;
    ...
    public static bool LoadBeatmaps() {
        try {
            ...
            Beatmaps = dirs.Select(item => {
                try { return new YusaBundongBeatmap(item); } 
                catch { return null; }
            }).Where(beatmap => beatmap != null).ToArray();
